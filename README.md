...
Plan retirement decumulation: tax-smart withdrawal order, dynamic/variable spending strategies (Guyton-Klinger guardrails, VPW, spending smile, bucket+buffer vs static 4% SWR), Social Security claiming age, ACA healthcare bridge before Medicare, projected RMDs with a tax-torpedo / Roth-conversion-runway readout (`analyze_rmd`), Medicare IRMAA tier and surcharge-cliff lookup (`analyze_irmaa`), guaranteed income, a bond/TIPS ladder income floor, long-term-care cost exposure, and estate-tax exposure. Thin orchestration over the planfi MCP.
...
![routing recall](https://img.shields.io/badge/routing%20recall-90%25-brightgreen) ![precision](https://img.shields.io/badge/precision-100%25-brightgreen)

- **Positive cases — called the right tool:** 9/10 (90%)
